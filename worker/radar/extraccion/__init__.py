...
from radar.extraccion.conector import enriquecer_desde_web, enriquecer_varias, registro_desde_texto
from radar.extraccion.reglas import DatosLegalesExtraidos, extraer

__all__ = ["DatosLegalesExtraidos", "enriquecer_desde_web", "enriquecer_varias", "extraer", "registro_desde_texto"]
